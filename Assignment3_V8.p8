...
function _draw()
 ...
 player_draw()
    ...
    if is_win then --moises
        local msg = "you win!"
        print(msg, 64-#msg*2, 15, 9) -- color 9 for testing
        local timer_msg = "tIME TO eSCAPE tHE cAVE: " .. flr(end_time) .. " sECS"
        print(timer_msg, 64-#timer_msg*2, 25, 9) -- white text under win message
...
states = {
    ...
    -- hook states as proper state tables (moises)
 ...
 if player.hooking and player.hooking_state == "pulling" then
  ...
  if map_collision(player, "up", 0) then
	...
	if player.k_timer > 0 then
        ...
        -- win condition
    if not is_win and player.y <= 35 then
        is_win = true
...
2160606060600121606060101010600140044f40004c44000004400040044f40004c440000440000000000000000000000000000000000000000000000000000
...
216161616161012161616101112161010000ccf00044ff0f000444f40000ccf00044ff0000444f40000000000000000000000000000000000000000000000000
...
216262626262012262626201312162010000ccf0000cfc0f00400cf00000ccff000cff000400cff0000000000000000000000000000000000000000000000000
...
216060606060226160606012126060010000111000440000000cccf000001111004400f000cccff0000000000000000000000000000000000000000000000000
